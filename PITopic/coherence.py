...
# Function to calculate word frequencies and word pair frequencies
...
# Function to calculate NPMI score
def calculate_npmi(topics, word_freq, word_pair_freq, num_docs, epsilon=1e-12):
    ...
    for topic_words in topics:
        ...
        if npmi_scores:  # Only add the average if there are valid scores
...
# Function to calculate UCI score
def calculate_uci(topics, word_freq, word_pair_freq, num_docs):
    ...
    for topic_words in topics:
        ...
        if uci_scores:  # Only add the average if there are valid scores
...
# Function to calculate UMass score
def calculate_umass(topics, word_freq, word_pair_freq, num_docs):
    ...
    for topic_words in topics:
        ...
        if umass_scores:  # Only add the average if there are valid scores
